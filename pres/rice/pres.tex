...
%% \end{textblock*}
  ...
  \begin{textblock*}{3cm}(5cm,1.35cm) % {block width} (coords)
    \textbf{Astronomers}
  \end{textblock*}
...
\begin{center}
  Star observed $\approx 250$ times in $5$ bands ($u,g,r,i,z$).
\end{center}
...
Need more efficient statistical methods for DES data.
\end{center}
