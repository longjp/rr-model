...
%% \end{textblock*}
  ...
  \begin{textblock*}{3cm}(1.25cm,1.3cm) % {block width} (coords)
    \textbf{Astronomers:}
  \end{textblock*}
...
\end{textblock*}
  ...
  \begin{textblock*}{3cm}(1.25cm,5.5cm) % {block width} (coords)
    \textbf{Statisticians:}
  \end{textblock*}

  \begin{textblock*}{3cm}(4cm,6.25cm) % {block width} (coords)
\includegraphics[width=\w,height=\h]{figs/zhenfeng.jpg}\\
Zhenfeng Lin
\end{textblock*}

  \begin{textblock*}{3cm}(7cm,6.25cm) % {block width} (coords)
...
\section{Time Domain Astronomy, Variable Stars, Galactic Halo, DES}
...
\section{Results on Stripe 82 Data}
...
\section{Dark Energy Survey Results}
