...
TODO: Reference other people with physical model. 

\begin{center}
global parameters fit once for all RR Lyrae\\
\includegraphics[scale=.3]{figs/model.png}\\
individual object parameters fit for each RR Lyrae
\end{center}
...
\item Warm start Newton--Raphson updates for $\phi$ parameter.
\end{itemize}
