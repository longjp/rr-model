...
\begin{frame}{Relation to Other Methods in Literature}
...
\item Hernitschek \cite{hernitschek2016finding} used structure functions to classify sparsely sampled RR Lyrae.
\end{itemize}
\end{frame}
...
\section{Related Work, Future Work and Conclusions}

\begin{frame}{Related Work}

TODO: cite pejeck and tom. various RR Lyrae model papers. sesar personal communication
