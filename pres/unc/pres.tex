...
\begin{frame}{Finding the RR Lyrae}
  ...
  \item make cuts to select regions of feature space containing mostly RR Lyrae
  \end{itemize}
...
\begin{column}{.5\textwidth}
  ...
  \item \textbf{data:} $\{(x_i,z_i)\}_{i=1}^n$
    ...
    \end{itemize}
  \item \textbf{dimension:} number of features ($=$ 2 here)
  \item here $K=2$
...
\begin{frame}{Variance and Bias}
  ...
  \item \textbf{bias:} how far, on average, is my estimate from the true value
