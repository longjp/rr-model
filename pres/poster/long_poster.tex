...
\item The \underline{global parameters} are estimated from a set of 309 well--observed SDSS Stripe 82 RR Lyrae AB \cite{sesar2010light}. For example, the $\gamma_b$ functions are shown in Figure \ref{fig:gamma}.
...
\item Use grid search and Newton algorithm

\item Examples of Fit
