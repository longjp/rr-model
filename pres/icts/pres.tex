...
\section{Background on Automated Variable Star Classification}
...
\begin{center}
\includegraphics[height=1.75in,width=4in]{figs/feats.png}
\end{center}
...
\includegraphics[height=3.3in,width=4.5in]{figs/pairs.pdf}
...
\includegraphics[height=3.2in,width=5in]{figs/tree.pdf}
...
\begin{center}
  ...
  Unfolded \, \, \,   \, \, \,   \, \, \,   \, \, \,   \, \, \,   \, \, \, Folded
\includegraphics[scale=.18]{figs/unfolded_13350.pdf}
...
\begin{frame}{Complicated, Multilevel Inference Process}
  ...
  \begin{center}
    \includegraphics[scale=0.3]{figs/chad_article.png}
